...
public abstract class FractalGenerator {
     ...
     *              используется для вычисления координаты на оси X или Y в заданном диапазоне и размере.
     */
     ...
     *  используется для изменения области фрактала, отображаемой на экране.
     */
     ...
     * with a result of -1.
     * используется для вычисления количества итераций для заданных координат.
     */
